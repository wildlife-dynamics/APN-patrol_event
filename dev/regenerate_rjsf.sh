...
GENERATED_DIR="ecoscope-workflows-patrol-event-workflow"
REGISTRY_BIN="${GENERATED_DIR}/.pixi/envs/default/bin/wt-registry"
REGISTRY_JSON="/tmp/wt_registry_apn_patrol_event.json"
...
out = Path('$GENERATED_DIR') / 'ecoscope_workflows_patrol_event_workflow' / 'rjsf.json'
